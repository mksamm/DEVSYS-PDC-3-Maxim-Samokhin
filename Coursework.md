...
>Добавляем данные в планировщик командой `sudo crontab -e`. Время выполнения установим на 21 мин каждого часа.
```
VAULT_ADDR=http://127.0.0.1:8200
VAULT_TOKEN=root

21 * * * * /usr/bin/python3 /home/vagrant/script1.py
```

10. Поместите скрипт в crontab, чтобы сертификат обновлялся какого-то числа каждого месяца в удобное для вас время.

>Добавляем данные в планировщик командой `sudo crontab -e`. Время выполнения выставил на 21 мин каждого часа.
```
VAULT_ADDR=http://127.0.0.1:8200
VAULT_TOKEN=root
