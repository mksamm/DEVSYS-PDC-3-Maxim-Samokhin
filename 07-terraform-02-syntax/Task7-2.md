...
C помощью инструмента Packer с плагином Amazon <https://www.packer.io/plugins/builders/amazon> Этот инструмент позволяет
создавать образы AMI. Также с помощью встроенных средств Amazon Web Services AMI можно создать из работающего инстанса.
