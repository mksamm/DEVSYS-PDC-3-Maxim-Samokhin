...
* Была исправлена ошибка в условии **while((1==1)** не хватало одной скобки
* Была исправлена ошибка с постоянным дополнением curl.log, вместо перезаписи
* Добавил break на случай если сервис доступен, скрипт перестает его пинговать
* Добавил sleep на 1 секунду после выполнения запроса, чтобы уменьшить нагрузку
